/*import {Link, useParams, useNavigate} from 'react-router'; //modifié
import usePokemon from '../hook/usePokemon';
import { useEffect, useState } from "react"; //nouveau
    ...
    return (
        ...
        <div>
            ...
            <p><strong>Poids :</strong> {editedPokemon.type.join(", ")}</p>
            </div>
            <h2>Modifications :</h2>
            <div>
                <label>Nom :</label>
